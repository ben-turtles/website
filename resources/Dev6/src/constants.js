...
// Level + player related constants
PB_GAME.CONSTANTS.STARTING_LEVEL = 0;
PB_GAME.CONSTANTS.START_AT_LAST = false;
PB_GAME.CONSTANTS.LEVEL_BG_COLOR = 0xffffff;
PB_GAME.CONSTANTS.LEVEL_RESTART_CONTROL = "P - Restart";
PB_GAME.CONSTANTS.GOAL_BORDER_SIZE = 3;
PB_GAME.CONSTANTS.GOAL_COLOR = 0xf59e42;
PB_GAME.CONSTANTS.WALL_COLOR = 0x000000;
PB_GAME.CONSTANTS.WALL_INVALID_COLOR = 0xFF0000;
PB_GAME.CONSTANTS.WALL_SIZE = 3;
PB_GAME.CONSTANTS.PLAYER_COLOR = PB_GAME.CONSTANTS.GOAL_COLOR;
PB_GAME.CONSTANTS.PLAYER_BORDER_SIZE = PB_GAME.CONSTANTS.GOAL_COLOR
PB_GAME.CONSTANTS.PLAYER_PREVIEW_COLOR = 0xFAD0A4;
PB_GAME.CONSTANTS.PLAYER_PREVIEW_INVALID_COLOR = 0xFFA8A8;
...
PB_GAME.CONSTANTS.PICKUP_COLOR = PB_GAME.CONSTANTS.PLAYER_COLOR;
PB_GAME.CONSTANTS.NEXT_LEVEL_LOAD_DELAY = 1;
PB_GAME.CONSTANTS.PREVIEW_PLAYER_TIMER_KEY = "Preview"

// Input constants
PB_GAME.CONSTANTS.MIN_TIME_GAP = 10
